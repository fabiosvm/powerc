...
typedef enum
{
  ...
  TOKEN_KIND_PLUSEQ,      TOKEN_KIND_PLUS,      TOKEN_KIND_ARROW,
  ...
  TOKEN_KIND_BOOL_KW,     TOKEN_KIND_BREAK_KW,  TOKEN_KIND_BYTE_KW,
  TOKEN_KIND_CONTINUE_KW, TOKEN_KIND_DO_KW,     TOKEN_KIND_ELSE_KW,
  TOKEN_KIND_FALSE_KW,    TOKEN_KIND_FLOAT_KW,  TOKEN_KIND_FN_KW,
  TOKEN_KIND_FOR_KW,      TOKEN_KIND_IF_KW,     TOKEN_KIND_IN_KW,
  TOKEN_KIND_INOUT_KW,    TOKEN_KIND_INT_KW,    TOKEN_KIND_LET_KW,
  TOKEN_KIND_LOOP_KW,     TOKEN_KIND_RETURN_KW, TOKEN_KIND_RUNE_KW,
