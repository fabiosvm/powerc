...
typedef enum
{
  ...
  TOKEN_KIND_RUNE,         TOKEN_KIND_STRING,    TOKEN_KIND_AS_KW,
  TOKEN_KIND_BREAK_KW,     TOKEN_KIND_CONST_KW,  TOKEN_KIND_CONTINUE_KW,
  ...
  TOKEN_KIND_INTERFACE_KW, TOKEN_KIND_LOOP_KW,   TOKEN_KIND_NEW_KW,
  TOKEN_KIND_RETURN_KW,    TOKEN_KIND_STRUCT_KW, TOKEN_KIND_TRUE_KW,
  TOKEN_KIND_TRY_KW,       TOKEN_KIND_TYPE_KW,   TOKEN_KIND_VAR_KW,
  TOKEN_KIND_VOID_KW,      TOKEN_KIND_WHILE_KW,  TOKEN_KIND_IDENT
} TokenKind;
