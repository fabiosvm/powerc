...
static inline void node_print(AstNode *node, int level)
{
  ...
  case AST_NODE_KIND_POLY_PARAMS:
...
const char *ast_node_kind_name(AstNodeKind kind)
{
  ...
  case AST_NODE_KIND_POLY_PARAMS:    name = "PolyParams";    break;
  ...
  case AST_NODE_KIND_SWITCH:         name = "Switch";        break;
  case AST_NODE_KIND_CASE:           name = "Case";          break;
  case AST_NODE_KIND_DEFAULT:        name = "Default";       break;
