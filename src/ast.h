...
typedef enum
{
  ...
  AST_NODE_KIND_ASSIGN,      AST_NODE_KIND_IF,        AST_NODE_KIND_LOOP,
  ...
  AST_NODE_KIND_GT,          AST_NODE_KIND_GE,        AST_NODE_KIND_RANGE,
  ...
  AST_NODE_KIND_GET_ELEMENT, AST_NODE_KIND_IDENT
} AstNodeKind;
