...
typedef enum
{
  AST_NODE_KIND_MODULE,      AST_NODE_KIND_FUNC_DECL,  AST_NODE_KIND_PARAMS,
  AST_NODE_KIND_INOUT_PARAM, AST_NODE_KIND_REF,        AST_NODE_KIND_VAR_DECL,
  ...
  AST_NODE_KIND_STRING_TYPE, AST_NODE_KIND_FUNC_TYPE,  AST_NODE_KIND_BLOCK,
  AST_NODE_KIND_ASSIGN,      AST_NODE_KIND_IF,         AST_NODE_KIND_RETURN,
  AST_NODE_KIND_OR,          AST_NODE_KIND_AND,        AST_NODE_KIND_EQ,
  AST_NODE_KIND_NE,          AST_NODE_KIND_LT,         AST_NODE_KIND_LE,
  AST_NODE_KIND_GT,          AST_NODE_KIND_GE,         AST_NODE_KIND_ADD,
  ...
  AST_NODE_KIND_STRING,      AST_NODE_KIND_IDENT
} AstNodeKind;
