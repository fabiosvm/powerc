...
typedef enum
{
  AST_NODE_KIND_MODULE,   AST_NODE_KIND_FUNC,      AST_NODE_KIND_PARAMS,
  AST_NODE_KIND_VAR_DECL, AST_NODE_KIND_VOID_TYPE, AST_NODE_KIND_BOOL_TYPE,
  AST_NODE_KIND_INT_TYPE, AST_NODE_KIND_UINT_TYPE, AST_NODE_KIND_FLOAT_TYPE,
  AST_NODE_KIND_BLOCK,    AST_NODE_KIND_ASSIGN,    AST_NODE_KIND_RETURN,
  ...
  AST_NODE_KIND_INT,      AST_NODE_KIND_FLOAT,     AST_NODE_KIND_IDENT
} AstNodeKind;
